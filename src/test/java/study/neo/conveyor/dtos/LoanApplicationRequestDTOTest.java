...
public class LoanApplicationRequestDTOTest {
    ...
    void testDeserialize() throws IOException {
        ...
        assertThat(loanApplicationRequestDTO.getFirstName()).isEqualTo("TestFirstName");
        assertThat(loanApplicationRequestDTO.getLastName()).isEqualTo("TestLastName");
        assertThat(loanApplicationRequestDTO.getMiddleName()).isEqualTo("TestMiddleName");
        assertThat(loanApplicationRequestDTO.getTerm()).isEqualTo(6);
        assertThat(loanApplicationRequestDTO.getAmount()).isEqualTo(BigDecimal.valueOf(13000));
        assertThat(loanApplicationRequestDTO.getBirthDate()).isEqualTo("1999-05-18");
        assertThat(loanApplicationRequestDTO.getEmail()).isEqualTo("TestEmail@mail.ru");
        assertThat(loanApplicationRequestDTO.getPassportSeries()).isEqualTo("1234");
        assertThat(loanApplicationRequestDTO.getPassportNumber()).isEqualTo("123456");
    }
}
