...
import study.neo.conveyor.service.classes.CreditDtoService;
import study.neo.conveyor.service.classes.ScoreCreditRate;
...
public class CreditDtoServiceTest {
    ...
    public void testCreateCreditDTO() {
        ...
        when(calculationService.calculateMonthlyPayment(any(BigDecimal.class), any(Integer.class), any(BigDecimal.class)))
                .thenReturn(BigDecimal.valueOf(25000));
        when(calculationService.compileListOfPaymentScheduleElements(any(Integer.class), any(BigDecimal.class),
